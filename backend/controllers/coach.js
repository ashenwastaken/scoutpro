...
const generatePdf = async (req, res) => {
  ...
  try {
    const apiKey = "fcFbqbhlzaW0nHgGKMToQgKNv8EtqSCqM0NrR5qs9gORH091v2Y5xzyYbwMEERto";
    ...
    console.error("Error generating PDF with HTML2PDF.app:", error.response?.data || error.message || error);
